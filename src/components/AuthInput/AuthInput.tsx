...
export function AuthInput({ placeholder, password = false, ...props }: AuthInputProps) {
    ...
    return (
        <div className={s.wrapper}>
            <input id={placeholder} className={s.input} {...props} required placeholder={placeholder} type={password ? !isPassword ? 'password' : 'text' : 'email'} />
            <label htmlFor={placeholder} className={s.input__text}>{placeholder}</label>
            {
