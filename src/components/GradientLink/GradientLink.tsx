...
export function GradientLink({ text, href, icon = 'arrow', borderRadius = 6 }: GradientLinkProps) {
    return (
        <Link href={href} className={s.link} style={{ borderRadius: borderRadius }}>
            {text}
            {
                icon === 'arrow' ?
